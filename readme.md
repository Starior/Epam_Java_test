...
3. [[link]](https://github.com/Starior/Epam_java_test/blob/master/src/com/starion/loki/basics/linear/Task_3.java)
   Calculate the value of the expression using the formula (all variables are valid):  
   <img src="https://latex.codecogs.com/svg.image?\frac{sinx&plus;cosy}{cosx-siny}\ast&space;tg&space;xy" title="\frac{sinx+cosy}{cosx-siny}\ast tg xy" />
4. [[link]](https://github.com/Starior/Epam_java_test/blob/master/src/com/starion/loki/basics/linear/Task_4.java)
